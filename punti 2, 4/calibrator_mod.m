function [V, ModelVol, MaxErr] = calibrator_mod(T,K_norm,MktVol,threshold,MaxIter,N,M,K_min,K_max,Scheme)
...
while ( MaxErr(nb_iter) > threshold && nb_iter < MaxIter )
    ...
    ModelVol = model_volatility_mod(T,K_norm,V,N,M,K_min,K_max,Scheme);
